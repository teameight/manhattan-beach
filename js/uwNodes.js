		...
		'objects': [
			{
				...
				'roty':3,
				'rotx':5,
				'content':'<p>This text could introduce or set the tone for the following items in this path. In the following slides, the images could appear alone, with a caption or no image, just text.<\/p>'
			},
			{
				'class':'image',
				'posx':5,
				...
				'roty':-4,
				'rotx':-5,
				'content':'<img alt="" src="' + imgRoot + '\/img\/Porthole.png" \/>'
			},
			{
				'class':'image',
				'posx':-8,
				...
				'roty':6,
				'rotx':5,
				'content':'<img alt="" src="' + imgRoot + '\/img\/ChartRoom.png" \/><p>Anna watched the sea. There was a feeling she had, standing at it&rsquo;s edge: an electric mix of attraction and dread. <\/p>'
			},
			{
				'class':'image',
				'posx':6,
				...
				'roty':4,
				'rotx':3,
				'content':'<p>This standalone text in the middle of an image gallery path could serve to add insight or build narrative.<\/p>'
			},
			{
				'class':'image',
				'posx':-5,
				...
				'roty':-2,
				'rotx':-4,
				'content':'<img alt="" src="' + imgRoot + '\/img\/convoy-3.png" \/><p>[This could be an image caption giving the explorer some context and adding to the overall narrative of this path.]<\/p>'
			}
		]
	},
	{
		...
		'objects': [
			{
				...
				'roty':-3,
				'rotx':5,
				'content':'<img alt="" src="http:\/\/team-eight.com\/open-dev\/jegan\/demo-assets\/diving-suit.png">',
			},
			{
				'class':'',
				'posx':15,
				...
				'roty':-3,
				'rotx':5,
				'content':'<p>[ A description of what the previous image is and the story around it ]<\/p>'
			}
		]
	},
	{
