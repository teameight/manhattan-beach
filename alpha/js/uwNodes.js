	...
	},
	{
		...
		'objects': [
			...
			},
			{
				...
				'roty':-4,
				'rotx':-5,
				'content':'<img alt="" src=".\/img\/Porthole.png" \/>'
			},
			{
				'class':'image',
				'posx':-8,
				...
				'roty':6,
				'rotx':5,
				'content':'<img alt="" src=".\/img\/ChartRoom.png" \/><p>Anna watched the sea. There was a feeling she had, standing at it&rsquo;s edge: an electric mix of attraction and dread. <\/p>'
			},
			{
				'class':'image',
				'posx':6,
			...
			},
			{
				...
				'roty':-2,
				'rotx':-4,
				'content':'<img alt="" src=".\/img\/convoy-3.png" \/><p>[This could be an image caption giving the explorer some context and adding to the overall narrative of this path.]<\/p>'
			}
		]
	},
	{
